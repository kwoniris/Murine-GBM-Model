### Computing statistical tests for differential gene analyses across ORlow and ORhigh groups to identify genes both across the entire tumor sample and in topic 2 (tumor infiltrative region) that show to be differentially expressed based on OR type.
...
### Metric 2: Wilcoxon Rank-Sum Test ### 
  ## IGKC only 
    ## get total Igkc gexp across all 8227 ORlow spots
    igkcORlow <- gexp1[3807:nrow(gexp1), 'Igkc']
    ## get total Igkc gexp across all 3806 ORhigh spots 
